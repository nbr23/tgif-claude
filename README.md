...
Create a bookmark in your browser and paste the bookmarklet content (output of `make` or simply the content of [bookmarklet.js](bookmarklet.js)), and click on the bookmark on the [claude.ai usage](https://claude.ai/settings/usage) page.
